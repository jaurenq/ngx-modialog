...
export class ModalModule {
   ...
   */
  static withComponents(entryComponents: Array<Type<any> | any[]>): ModuleWithProviders<any> {
    return {
   ...
   * @param entryComponents A list of dynamically inserted components (dialog's).
   */
  static forRoot(entryComponents?: Array<Type<any> | any[]>): ModuleWithProviders<any> {
    return {
      ngModule: ModalModule,
      providers: [
